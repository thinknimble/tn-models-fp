...
import { toCamelCase, toSnakeCase as toSnakeCase2 } from "@thinknimble/tn-utils";
...
var isZodArray = (input) => {
  var _a;
  return isZod(input) && ((_a = input._def) == null ? void 0 : _a.typeName) === z3.ZodFirstPartyTypeKind.ZodArray;
};
var isZodObject = (input) => {
  var _a;
  return isZod(input) && ((_a = input._def) == null ? void 0 : _a.typeName) === z3.ZodFirstPartyTypeKind.ZodObject;
};
var isZodOptional = (input) => {
  var _a;
  return isZod(input) && ((_a = input._def) == null ? void 0 : _a.typeName) === z3.ZodFirstPartyTypeKind.ZodOptional;
};
var isZodNullable = (input) => {
  var _a;
  return isZod(input) && ((_a = input._def) == null ? void 0 : _a.typeName) === z3.ZodFirstPartyTypeKind.ZodNullable;
};
...
var isZodIntersection = (input) => {
  var _a;
  return isZod(input) && ((_a = input._def) == null ? void 0 : _a.typeName) === z3.ZodFirstPartyTypeKind.ZodIntersection;
};
var isZodUnion = (input) => {
  var _a;
  return isZod(input) && ((_a = input._def) == null ? void 0 : _a.typeName) === z3.ZodFirstPartyTypeKind.ZodUnion;
};
var isZodBrand = (input) => {
  var _a;
  return isZod(input) && ((_a = input._def) == null ? void 0 : _a.typeName) === z3.ZodFirstPartyTypeKind.ZodBranded;
};
...
function zodObjectToSnakeRecursive(zodObj) {
  ...
  return zodObj._def.unknownKeys === "passthrough" ? z3.object(resultingShape).passthrough() : z3.object(resultingShape);
}
...
var objectToSnakeCaseArr = (obj) => {
  ...
  const newEntries = [];
  for (const [k, v] of entries) {
    newEntries.push([toSnakeCase2(k), objectToSnakeCaseArr(v)]);
  }
  return Object.fromEntries(newEntries);
};
var createToApiHandler = (inputShape) => {
  ...
  return (obj) => {
    try {
      const result = zodObjectToSnakeRecursive(z4.object(inputShape)).parse(objectToSnakeCaseArr(obj));
      return result;
    } catch (e) {
      console.error(`${createToApiHandler.name} - error`, e);
      throw e;
...
var getPaginatedShape = (zodRawShape, options = { allowPassthrough: false }) => {
  const zObject = options.allowPassthrough ? z5.object(zodRawShape).passthrough() : z5.object(zodRawShape);
  return {
    count: z5.number(),
    next: z5.string().nullable(),
    previous: z5.string().nullable(),
    results: z5.array(zodObjectToSnakeRecursive(zObject))
  };
};
var getPaginatedSnakeCasedZod = (zodRawShape) => z5.object(getPaginatedShape(zodRawShape, { allowPassthrough: true })).passthrough();
var getPaginatedZod = (zodRawShape) => z5.object({
  count: z5.number(),
  next: z5.string().nullable(),
  previous: z5.string().nullable(),
  results: z5.array(z5.object(zodRawShape))
});
...
var createCustomServiceCall = (args) => {
  const inputShape = typeof args === "function" || !args.inputShape ? z6.void() : args.inputShape;
  const outputShape = typeof args === "function" || !args.outputShape ? z6.void() : args.outputShape;
  const filtersShape = typeof args === "function" || !args.outputShape || !("filtersShape" in args) ? z6.void() : args.filtersShape;
...
var standAlone = (args) => {
  var _a, _b, _c;
  const inputShape = (_a = args.models && "inputShape" in args.models ? args.models.inputShape : void 0) != null ? _a : z6.void();
  const outputShape = (_b = args.models && "outputShape" in args.models ? args.models.outputShape : void 0) != null ? _b : z6.void();
  const filtersShape = (_c = args.models && "filtersShape" in args.models ? args.models.filtersShape : void 0) != null ? _c : z6.void();
...
var createApi = (args) => {
  ...
  const updateBase = (_0) => __async(void 0, [_0], function* ({
    ...
    const entityWithoutReadonlyFieldsZod = z7.object(entityShapeWithoutReadonlyFields);
...
var paginationObjShape = {
  pagination: z8.instanceof(Pagination)
};
var createPaginatedServiceCall = ({
  ...
  if (inputShape) {
    return {
      ...
      filtersShape: filtersShapeResolved != null ? filtersShapeResolved : z8.void()
    };
  }
  return {
    callback,
