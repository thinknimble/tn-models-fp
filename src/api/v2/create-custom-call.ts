 ...
 */
export function createCustomServiceCallV2<
 ...
 */
export function createCustomServiceCallV2<TInput extends z.ZodRawShape | ZodPrimitives | z.ZodArray<z.ZodTypeAny>>(
  models: CustomServiceCallInputObj<TInput>,
...
export function createCustomServiceCallV2(...args: any[]): CustomServiceCallOpts<any, any, any> {
 ...
 */
createCustomServiceCallV2.standAlone = standAlone
